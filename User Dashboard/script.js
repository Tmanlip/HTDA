...
const dashToggle = document.querySelector(".home"),
    ...
    groupToggle = document.querySelector(".home-5"),
    resourceToggle = document.querySelector(".home-6"),
...
const dashcont = document.querySelector(".one-box-dash"),
    ...
    reportToggle.addEventListener("click", ()=>{
        window.location.href = "http://localhost/HiTDA/Feedback%20and%20Reporting/user-report.php"; // Replace with the URL of the next page
    })

    groupToggle.addEventListener("click", ()=>{
        window.location.href = "http://localhost/HiTDA/Peer%20Connect/pConnect.php"; // Replace with the URL of the next page
    })

    resourceToggle.addEventListener("click", ()=>{
        window.location.href = "http://localhost/HiTDA/Resource%20Sharing/resourceSharing.php"; // Replace with the URL of the next page
    })