    ...
    <nav>
        ...
        <main>
            ...
            <div class="display-container">
                ...
                <p class="line"><strong>Author:</strong> <?php echo $name; ?></p> 
                <p class="line"><strong>Email:</strong> <?php echo $email; ?></p> 
                <p class="line"><strong>Summary:</strong> <?php echo $summary; ?></p> 
                <br><br>
                <div>
                    <?php echo $content; ?>
                </div> 
