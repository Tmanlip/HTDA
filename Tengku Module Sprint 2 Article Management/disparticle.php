...
$data = json_decode(file_get_contents($filePath), true); // Filter pending articles 
$ApprovedArticles = array_filter($data, function($article) { 
            ...
            <div class="container">
                ...
                <div class="article-container">
                    <?php foreach ($ApprovedArticles as $article): ?> 
                        <form action="pok.php" method="POST" class="article"> 
                            <input type="hidden" name="id" value="<?php echo htmlspecialchars($article['id']); ?>"> 
                            <p><strong>Author:</strong> 
                            <?php echo htmlspecialchars($article['name']); ?></p> 
                    ...
                    <!-- <a href="artcile.php" style="text-decoration: none;"></a> -->

                <!-- <div class="article">
                    <h2><a href="three.html?id=2" target="_blank">Article Title 2</a></h2>
                    <p><strong>Author:</strong> Jane Smith</p>
                    <p><strong>Content:</strong> Pellentesque habitant morbi tristique senectus et netus...</p>
                    <div class="article-actions">
                        <button class="approve" onclick="approveArticle(2)">Approve</button>
                        <button class="reject" onclick="rejectArticle(2)">Reject</button>
                    </div>
                </div>
                Loop ends here -->
            </div>
